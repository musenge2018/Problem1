...
# ╔═╡ 73f49b24-054f-11f0-1791-312c8852c748
using PlutoUI

# ╔═╡ 0fe47d75-0c49-47ca-af3a-34415b9b41bd
using CSV

# ╔═╡ 25d10000-55e6-4941-a2f9-55371456d0e0
using DataFrames

# ╔═╡ 34bbe6c7-c493-414c-a12d-79d61b02a193
using MLJ

# ╔═╡ 0b8ed5a2-2272-4bf4-a03c-7e12c8bbe3a0
using Statistics

# ╔═╡ 3e2f8f4d-1bc9-43e7-a0e6-f88fca101c51
using StatsBase

# ╔═╡ 2ffe5f07-1d5f-4430-93cf-5f57f55a8638
using CairoMakie

# ╔═╡ 61ad084c-a600-4fb1-8057-8414954acde4
using AlgebraOfGraphics

# ╔═╡ 8fcbe78b-0eac-4756-b024-19478de8fd34
using Random

# ╔═╡ 89f6d58e-c751-4cd1-8806-b18c30ae0ebe
using MLJLinearModels

# ╔═╡ c9e31e8f-f2bb-4275-b875-c92eade0bed0
using MLJLIBSVMInterface

# ╔═╡ 9f817e4d-96e5-46df-a490-0280d4ba97e8
using LIBSVM

# ╔═╡ 0b9de193-55f1-4117-8f52-4f4c519291a4
using NearestNeighborModels

# ╔═╡ 190c7c96-580d-469c-88f9-60bfe93a42f7
using EvoTrees
...
# ╔═╡ e0a58bee-e778-4ede-ba28-42ae564e25f1
using MLUtils
...
# ╠═╡ disabled = true
#=╠═╡
df_clean = dropmissing(dataframe)

  ╠═╡ =#

# ╔═╡ 935e4219-6064-4496-8db8-704fe31fad0a
df_clean = unique(dataframe)
...
# Compute residuals
residuals = test_data.Economic_Loss - test_data.predicted

# Scatter plot of residuals
scatter!(ax, test_data.predicted, residuals, label="Residuals")

# Zero reference line
hlines!(ax, [0], color=:red, linestyle=:dash, label="Zero Line")
...
manifest_format = "2.0"
project_hash = "b040b18e61d214f10141c7714e4f40e76477e4c9"
...
git-tree-sha1 = "79a4d55fb2aed62053dd85961278b8090c972367"
